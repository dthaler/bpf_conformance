...
static const std::set<bpf_conformance_instruction_t, InstCmp> instructions_from_spec = {
    ...
    {bpf_conformance_test_cpu_version_t::v1, bpf_conformance_groups_t::legacy, 0x20},
    ...
    {bpf_conformance_test_cpu_version_t::v1, bpf_conformance_groups_t::legacy, 0x28},
    ...
    {bpf_conformance_test_cpu_version_t::v1, bpf_conformance_groups_t::legacy, 0x30},
    ...
    {bpf_conformance_test_cpu_version_t::v1, bpf_conformance_groups_t::legacy, 0x40},
    ...
    {bpf_conformance_test_cpu_version_t::v1, bpf_conformance_groups_t::legacy, 0x48},
    ...
    {bpf_conformance_test_cpu_version_t::v1, bpf_conformance_groups_t::legacy, 0x50},
